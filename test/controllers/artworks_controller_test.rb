...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { caption: @artwork.caption, description: @artwork.description, picture: @artwork.picture }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { caption: @artwork.caption, description: @artwork.description, picture: @artwork.picture }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
